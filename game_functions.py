...
def update_bullets(ai_setttings, screen, stats, sb, ship, aliens, bullets):
    """更新子弹的位置，并删除已消失的子弹"""
    # 更新子弹的位置
    bullets.update()
    ...
    check_bullet_alien_collisions(ai_setttings, screen, stats, sb, ship, aliens, bullets)
...
def create_alien(ai_settings, screen, alines, alien_number, row_number):
    """创建一个外星人并将其放在当前行"""
